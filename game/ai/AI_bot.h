...
const int AI_BOT_WEAPON_DROP_TIME = 20 * 1000;
...
enum {
	AI_BOT_SAY_GENERIC = 0,	// 0
	AI_BOT_SAY_WATCHOUT,	// 1
	AI_BOT_SAY_SIGHT,		// 2
	AI_BOT_SAY_SIGHT_GOBLIN,// 3
	AI_BOT_SAY_SIGHT_RAT,	// 4
	AI_BOT_SAY_SIGHT_SPIDER,// 5
	AI_BOT_SAY_SIGHT_UNDEAD,// 6
	AI_BOT_SAY_BACKTOIDLE,	// 7
	AI_BOT_SAY_SUSPICIOUS,	// 8
	AI_BOT_SAY_STARTMOVE,	// 9
	AI_BOT_SAY_LOST,		// 10
	AI_BOT_SAY_AFTERLOST,	// 11
	AI_BOT_SAY_DAMAGED,		// 12
	AI_BOT_SAY_FIRE,		// 13
	AI_BOT_SAY_MATEDOWN,	// 14
	AI_BOT_SAY_CHATTER,		// 15
