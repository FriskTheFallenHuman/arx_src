...
// ---> Arx - Solarsplace
	const idMaterial *	poisonMaterial;			// Green haze to indicate player is poisoned
	const idMaterial *	justLeftWaterMaterial;	// Drops on screen when leaving water
	const idMaterial *	blurMaterial;			// Blur vision when under water
// <--- Arx
